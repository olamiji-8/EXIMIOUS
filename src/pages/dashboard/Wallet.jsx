      ...
      <div className="wallet-wrapper">
        ...
        <div className="wallet-options">
          <div className="first-wallet">
            ...
            <button className="first-wallet-button">
        ...
        <>
          <div className="wallet-trans-list">
            ...
            <div className="wallet-transDiv">
              ...
              <div className="trans-text">Added Money to your Wallet <div className="trans-date">12/02/2021</div></div>
              <div className="wallet-processing">
            ...
            <div className="wallet-transDiv">
              ...
              <div className="trans-text">You made a Withdrawal <div className="trans-date">12/02/2021</div></div>
              <div className="wallet-processing">
                <div className="failed-text">Failed</div>
              </div>
              <div className="wallet-price" style={{color: "#F80E0E"}}>N200,000,000</div>
            </div>
          </div>
        </>
      </div>
